...
const STRINGS = {
  zh: {
    ...
    invalid_status: "无效状态",
    invalid_action: "无效操作",
    scan_limits: "扫描范围最多 90 天、一次 200 封邮件。",
    scan_days_max: "扫描天数最多 90 天。",
    scan_emails_max: "一次最多扫描 200 封邮件。",
  ...
  en: {
    ...
    scan_limits: "Scan lookback is at most 90 days and 200 messages.",
    scan_days_max: "Scan lookback is at most 90 days.",
    scan_emails_max: "Scan at most 200 messages at a time.",
